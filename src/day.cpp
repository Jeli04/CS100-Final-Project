...
Day::Day(ToDoList* _toDoList, CourseList* _courseList, const string& _date){
    toDoList = _toDoList;
    courseList = _courseList;
    dayNumber = stoi(_date.substr(3, 2));  // gets the first two characters
    date = _date;
...
void Day::displayDayInfo(ostream& ss) {
